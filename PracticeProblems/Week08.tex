...
% ******************************
\item Consider the single spring/mass system shown below, with no damper:
...
\item Set $m =0.5$ kg, $k = 10$ N/m, and $\Fext$ to zero (no external
  ...
  \verb#springDE1.m#. Use \verb#ode45# to simulate the motion of the
...
have the code that will run this simulation.
