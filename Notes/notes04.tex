...
\begin{center}
%\includegraphics[width=7.5cm]{graphics/week06_sin}
\end{center}
...
%\lscapepstricks{graphics/w06.intproperties.pstricks}
%\lscapepstricks{graphics/w06.intpropertiesB.pstricks}
...
%%%%%% DAWN omitted this proof on AUGUST 8, 2007 %%%%%%%%%%%%%%%%%%%%%%%
 %\ques{Prove Property 8 using Property 7.}
%\includesoln{\solntest}{}{%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%We have to prove that if $f(x)\geq g(x)$, then $$\int_a^b
%f(x)\,dx-\int_a^b g(x)\,dx\geq 0.$$ By Property 4, the left hand side of
%this inequality is equivalent to
%$$\int_a^b\bigr[\underbrace{f(x)-g(x)}_{positive}\bigl]dx.$$
%We know that $f(x)-g(x)\geq 0$. We could let $h(x)=f(x)-g(x)$, so
%therefore $h(x)\geq 0$.  But by Property 7 we know that if $h(x)\geq 0$
%then $\displaystyle\int_a^b h(x)\geq 0.$  So therefore $$\int_a^b
%f(x)\,dx-\int_a^b g(x)\,dx\geq 0.$$ \mbox{}\hfill $\blacksquare$
%}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\newpage %%%%%%%%%%%%%%%%%%%%%%New page%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\lscapepstricks{graphics/w06.function.pstricks}
...
%Once we recognize that solving an integral boils down to finding an
%anti-derivative for the integrand, this business of finding
%anti-derivatives suddenly becomes very important, and it makes sense
%to do exercises asking for them.
% \conques{%
% If $\displaystyle G(u) = \int_a^u F^\prime (x) \, dx$, then
% \begin{enumerate}%
% \item[A. ] $F$ is the derivative of $G$
% \item[B. ] $G$ is the derivative of $F$
% \item[C. ] $F$ and $G$ are equal
% \item[D. ] $F$ and $G$ differ by a constant
% \end{enumerate}
% }%
% \includesoln{\solntest}{\vspace{3cm}}{%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% By the first part of the Fundamental Theorem of Calculus, $G^\prime$
% is equal to the integrand.  That is, $G^\prime=F^\prime$.  But that
% means that $F$ and $G$ differ by a constant.  Thus D is the correct
% answer.
% }%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
